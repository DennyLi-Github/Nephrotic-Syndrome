...
selectGenesUp <- final_separate[final_separate$logFC>sig_lfc, 'Entrez_ID']
selectGenesDown <-final_separate[final_separate$logFC<(-sig_lfc), 'Entrez_ID']
...
foldchanges <- final_separate$logFC
...
col_order <- c("SYMBOL", "logFC", "adj.P.Val")
